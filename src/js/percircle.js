(function (factory) {
  ...
  $.fn.percircle = function (options) {
    ...
    return this.each(function () {
      // extend with any provided options, options are local to each instance in case of data attributes
      ...
      if (percent || localOptions.displayTextAtZero) {
        ...
        setInterval(function () {
          ...
          percircle.html('<span>' + text + '</span>');
          // add divs for structure
          $('<div class="slice"><div class="bar" ' + progressBarStyle + '></div><div class="fill" ' + progressBarStyle + '></div></div>').appendTo(percircle);
